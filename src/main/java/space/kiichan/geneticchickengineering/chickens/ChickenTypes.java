    ...
    private static final Map<Integer, Object[]> typemap = new LinkedHashMap<Integer, Object[]>() {
        {
            ...
            put(53, new Object[]{"粘土",new ItemStack(Material.CLAY)});
            put(54, new Object[]{"橡木",new ItemStack(Material.OAK_LOG)});
            put(57, new Object[]{"火药",new ItemStack(Material.GUNPOWDER)});
            put(58, new Object[]{"海带",new ItemStack(Material.KELP)});
            put(60, new Object[]{"史莱姆",new ItemStack(Material.SLIME_BALL)});
            put(7, new Object[]{"黄金",new ItemStack(Material.GOLD_INGOT)});
            ...
            put(19, new Object[]{"铁",new ItemStack(Material.IRON_INGOT)});
            ...
            put(38, new Object[]{"镁粉", SlimefunItems.MAGNESIUM_DUST});
            ...
            put(49, new Object[]{"红石",new ItemStack(Material.REDSTONE)});
            ...
            put(4, new Object[]{"海晶砂粒",new ItemStack(Material.PRISMARINE_CRYSTALS)});
            ...
            put(0, new Object[]{"下界合金",new ItemStack(Material.NETHERITE_INGOT)});
        }
    };
